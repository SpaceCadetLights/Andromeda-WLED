...
#define WLED_CODENAME "Lightdrive Andromeda"
...
WLED_GLOBAL char apSSID[33] _INIT("Andromeda");                             // AP off by default (unless setup)
...
WLED_GLOBAL char serverDescription[33] _INIT("Andromeda");  // Name of module
...
WLED_GLOBAL char alexaInvocationName[33] _INIT("Andromeda");          // speech control name of device. Choose something voice-to-text can understand
